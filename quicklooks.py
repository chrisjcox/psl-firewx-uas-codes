...
ax = plt.axes()
contour1 = ax.contour(times2d, hts2d, rh*100,levels=np.arange(0, 101, 2), colors='k', linewidths=0.2)
contour2 = ax.contourf(times2d, hts2d, rh*100,levels=np.arange(0, 101, 2), cmap='YlGnBu')
